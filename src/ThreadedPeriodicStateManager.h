...
public:
     ...
     */
    void saveState(const VTime& currentTime,unsigned int eventNumber, SimulationObject* object,
                   const ObjectID senderId,
                   int threadID);
    ...
    void updateStateWhileCoastForward(const VTime& currentTime, unsigned int eventNumber,
