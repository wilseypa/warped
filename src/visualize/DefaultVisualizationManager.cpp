...
DefaultVisualizationManager::DefaultVisualizationManager(TimeWarpSimMgrWithVisualization* mySimMgr,
                                                         map<const string, string>& configurationMap) : VisualizationManager(mySimMgr) {
...
int
DefaultVisualizationManager::openVisualizationObject(const char*, VisualizationManager::DisplayKind,
                                                     DefaultVisualizationManager::VisualizationTools) {
...
int
DefaultVisualizationManager::openVisualizationObject(const char*, VisualizationManager::DisplayKind,
                                                     VisualizationManager::VisualizationTools,  VisualizationManager::DataType, void*) {
    return 0;  // Quiet the compiler down.
}
