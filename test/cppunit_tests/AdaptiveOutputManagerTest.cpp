...
DynamicOutputManagerTest::testDynamicCancel() {
    ...
    for (int b = 2; b < 20; b = b + 3) {
        CPPUNIT_ASSERT(!toCheck->checkDynamicCancel(new UnitTestEvent(*new IntVTime(b + 1), getSimObj1ID(),
                                                                      *new IntVTime(b))));
    }
    CPPUNIT_ASSERT(!toCheck->checkDynamicCancel(new UnitTestEvent(*new IntVTime(21), getSimObj1ID(),
                                                                  *new IntVTime(20))));
    ...
    for (int d = 25; d < 40; d++) {
        toCheck->checkDynamicCancel(new UnitTestEvent(*new IntVTime(d + 1), getSimObj1ID(),
                                                      *new IntVTime(d)));
    }
    CPPUNIT_ASSERT(!toCheck->checkDynamicCancel(new UnitTestEvent(*new IntVTime(41), getSimObj1ID(),
                                                                  *new IntVTime(40))));
    ...
    for (int d = 44; d < 60; d++) {
        CPPUNIT_ASSERT(toCheck->checkDynamicCancel(new UnitTestEvent(*new IntVTime(d + 1), getSimObj1ID(),
                                                                     *new IntVTime(d))));
    }
    CPPUNIT_ASSERT(!toCheck->checkDynamicCancel(new UnitTestEvent(*new IntVTime(61), getSimObj1ID(),
                                                                  *new IntVTime(60))));
    ...
    for (int g = 62; g < 80; g = g + 6) {
        toCheck->checkDynamicCancel(new UnitTestEvent(*new IntVTime(g + 1), getSimObj1ID(),
                                                      *new IntVTime(g)));
    }
    CPPUNIT_ASSERT(!toCheck->checkDynamicCancel(new UnitTestEvent(*new IntVTime(81), getSimObj1ID(),
                                                                  *new IntVTime(80))));
