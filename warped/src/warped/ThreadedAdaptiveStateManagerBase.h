#ifndef THREADEDADAPTIVESTATEMANAGERBASE_HH
#define THREADEDADAPTIVESTATEMANAGERBASE_HH
...
/** The ThreadedAdaptiveStateManagerBase class.
 ...
 */
class ThreadedAdaptiveStateManagerBase: public ThreadedStateManagerImplementationBase {

public:

	/**@name Public Class Methods of ThreadedAdaptiveStateManagerBase. */
	//@{
	 ...
	 */
	ThreadedAdaptiveStateManagerBase(ThreadedTimeWarpSimulationManager *simMgr);

	/// Destructor.
	virtual ~ThreadedAdaptiveStateManagerBase() {
	}
	;
