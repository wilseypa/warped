...
public:
  ...
  */
  ...
  void initializePhysicalCommunicationLayer( SimulationConfiguration &configuration ){
  ...
  */
  ...
  void setRecoveringFromCheckpoint(bool inRec) { recoveringFromCkpt = inRec; }

  /// Increments the number of recoveries from catastrophic rollbacks.
  void incrementNumRecoveries() { numCatastrophicRollbacks++; }
