#ifndef THREADEDOUTPUTMANAGER_H
#define THREADEDOUTPUTMANAGER_H
...
/** The ThreadedOutputManager class.
 ...
 */
class ThreadedOutputManager: virtual public Configurable {
public:

	/**@name Public Class Methods of ThreadedOutputManager. */
	//@{

	/// Destructor
	virtual ~ThreadedOutputManager() {
	}
	;
	...
	//@} // End of Public Class Methods of ThreadedOutputManager.

protected:

	/**@name Protected Class Methods of ThreadedOutputManager. */
	//@{

	/// Default Constructor
	ThreadedOutputManager() {
	}
	;
