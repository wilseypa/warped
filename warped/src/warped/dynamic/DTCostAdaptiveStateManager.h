#ifndef DTCOSTADAPTIVESTATEMANAGER_HH
#define DTCOSTADAPTIVESTATEMANAGER_HH

// See copyright notice in file Copyright in the root directory of this archive.

#include "DTAdaptiveStateManagerBase.h"

/** The DTCostAdaptiveStateManager class.
...
class DTCostAdaptiveStateManager: public DTAdaptiveStateManagerBase {
public:

	/**@name Public Class Methods of DTCostAdaptStateManager. */
	//@{
	 ...
	 */
	DTCostAdaptiveStateManager(DTTimeWarpSimulationManager *simMgr);

	// Destructor
	~DTCostAdaptiveStateManager() {
	}
	;
