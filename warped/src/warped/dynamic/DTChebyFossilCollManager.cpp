...
#include "DTChebyFossilCollManager.h"
#include "Event.h"
...
DTChebyFossilCollManager::DTChebyFossilCollManager(DTTimeWarpSimulationManager *sim,
                                               int checkPeriod,
                                               int minimumSamples,
                                               int maximumSamples,
                                               int defaultLen,
                                               double risk):
  DTOptFossilCollManager(sim, checkPeriod, minimumSamples, maximumSamples, defaultLen, risk),
  errorTerm(2.576){
...
DTChebyFossilCollManager::~DTChebyFossilCollManager(){
}

void
DTChebyFossilCollManager::sampleRollback(SimulationObject *object, const VTime &rollVTime){
