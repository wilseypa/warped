#ifndef DTTIMEWARPEVENTSET_H_
#define DTTIMEWARPEVENTSET_H_
...
/** The DTTimeWarpEventSet abstract base class.
 ...
 The DTTimeWarpEventSet contains input events to the simulation kernel.  It
 "owns" them and is responsible for their reclaimation at fossil
 collection time.
 */
class DTTimeWarpEventSet: virtual public Configurable {

	/**@type friend class declarations */
	//@{

	/// Factory class for DTTimeWarpEventSet
	friend class TimeWarpEventSetFactory;

	//@} // End of friend class declarations

public:
	/**@name Public Class Methods of DTTimeWarpEventSet. */
	//@{

	/// Virtual Destructor
	virtual ~DTTimeWarpEventSet();
	...
	//@} // End of Public Class Methods of DTTimeWarpEventSet.
...
protected:
	...
	//@} // End of Protected Class Methods of DTTimeWarpEventSet.
};

#endif /* DTTIMEWARPEVENTSET_H_ */
