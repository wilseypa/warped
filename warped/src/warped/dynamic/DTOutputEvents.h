...
/** The DTOutputEvents class.

 This class is a container for output events of a single
 simulation object.
 */
class DTOutputEvents {
public:

	/**@name Public Class Methods of DTOutputEvents. */
	//@{

	/** Constructor
	 @param simMgr A handle to the simulation manager.
	 */
	DTOutputEvents(DTTimeWarpSimulationManager *simMgr);
	...
	//@} // End of Public Class Methods of DTOutputEvents.
...
private:
	...
	/**@name Private Class Methods of DTOutputEvents. */
	//@{
	...
	//@} // End of Private Class Methods of DTOutputEvents.
};

#endif /* DTOUTPUTEVENTS_H_ */
