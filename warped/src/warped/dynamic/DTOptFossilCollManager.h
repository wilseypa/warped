...
#ifndef DTOPTFOSSILCOLLMANAGER_H_
#define DTOPTFOSSILCOLLMANAGER_H_
...
*/
class DTOptFossilCollManager : virtual public CommunicatingEntity,
...
public:
  ...
  */
  DTOptFossilCollManager(DTTimeWarpSimulationManager *sim,
                       int checkPeriod,
                       int minimumSamples,
                       int maximumSamples,
                       int defaultLen,
  ...
  // Destructor.
  virtual ~DTOptFossilCollManager();
  ...
  */
  virtual void checkpoint(const VTime &checkTime, const ObjectID &objId, const unsigned int &threadId);
  ...
  */
  virtual void fossilCollect(SimulationObject *object, const VTime &currentTime, const unsigned int &threadId);
...
protected:
  ...
  DTTimeWarpSimulationManager *mySimManager;
...
#endif /* DTOPTFOSSILCOLLMANAGER_H_ */
