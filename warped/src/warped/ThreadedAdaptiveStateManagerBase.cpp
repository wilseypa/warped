...
ThreadedAdaptiveStateManagerBase::ThreadedAdaptiveStateManagerBase(
...
void ThreadedAdaptiveStateManagerBase::startStateTiming(unsigned int id) {
	stopWatch[id].start();
}

void ThreadedAdaptiveStateManagerBase::stopStateTiming(unsigned int id) {
	stopWatch[id].stop();
	StateSaveTimeWeighted[id].update(stopWatch[id].elapsed());
}

void ThreadedAdaptiveStateManagerBase::saveState(const VTime& currentTime,
