...
SimulationObject*
NInputOrGateStub::createSimulationObject(int numberOfArguments,
                                           ostrstream &argumentStream) {

   if(numberOfArguments < 3){
      cerr << "Invalid number of parameters for NInputOrGate" << endl;
   ...
   SimulationObject *newObject = new NInputOrGate(objName,
                                                  numberOfInputs,
                                                  numberOfOutputs,
                                                  outputObjectNames,
                                                  destinationPorts,
