...
SimulationObject*
NInputXorGateStub::createSimulationObject(int numberOfArguments,
                                            ostrstream &argumentStream) {

   if(numberOfArguments < 3){
      cerr << "Invalid number of parameters for NInputXorGate" << endl;
   ...
   SimulationObject *newObject = new NInputXorGate(objName,
                                                   numberOfInputs,
                                                   numberOfOutputs,
                                                   outputObjectNames,
                                                   destinationPorts,
